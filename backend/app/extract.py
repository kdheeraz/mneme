...
SYSTEM = (
    ...
    "2. Preserve concrete specifics VERBATIM — names, numbers, quantities, titles, places, "
    "   brands, prices. Never collapse a specific into a generic category. Write 'User was "
    "   recommended Grilled Snapper with Mango Salsa' (NOT 'User likes seafood'); 'The Chiefs "
    "   played the Jaguars 12 times at Arrowhead Stadium' (NOT 'User is interested in NFL "
    "   history'). The specific detail is usually the thing worth remembering.\n"
    "3. Capture salient facts from BOTH speakers, not only facts about the user. Also record "
    "   concrete information the assistant provided that the user may later refer back to — "
    "   recommendations, names, answers, prices, how-to steps (e.g. 'The assistant recommended "
    "   the International Budget Hostel near the Red Light District in Amsterdam').\n"
    "4. Attach dates to events. The conversation may be prefixed with a date marker like "
    "   '[Date: 2023/04/10]'. For any event, action, plan, or dated statement, include the "
    "   absolute date in the memory (e.g. 'User completed the charity 5K on 2023-04-10'). "
    "   Resolve relative references ('yesterday', '5 days ago', 'last Tuesday') to absolute "
    "   dates using that marker.\n"
    "5. Record the resulting CURRENT STATE, not transitional language. When the user describes "
    ...
    "7. Skip chit-chat, greetings, and anything not worth long-term recall.\n"
    "8. Output STRICT JSON, no preamble, no markdown fences. Schema:\n"
    '   {"memories":[{"content":"...","kind":"semantic|episodic|procedural"}, ...]}\n'
    "9. If there is nothing worth extracting, output: {\"memories\":[]}"
)
